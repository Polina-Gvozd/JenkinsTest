...
public class Mesto1Test {
        String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2N2VkNmYzN2FmYmVhMDA2MjczMmQ4ZjIiLCJpYXQiOjE3NDg2MzE1OTYsImV4cCI6MTc0OTIzNjM5Nn0.JKD0Hxo7bTrO02rKeXrIrb_bQe2E9ff8d5JPWddDThA";
        ...
        public void addNewPhoto() {
            given()
                    ...
                    .then().statusCode(203); // Проверяем код ответа
        }
